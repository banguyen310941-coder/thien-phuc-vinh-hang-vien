...
productStyle.textContent=`#sanpham .cards{grid-template-columns:repeat(3,1fr)}#sanpham .cards article{padding:0 0 25px;overflow:hidden}.product-photo{display:block;width:100%;aspect-ratio:16/10;object-fit:cover;margin-bottom:22px;border-radius:14px 14px 0 0}#sanpham .cards article h3,#sanpham .cards article p,#sanpham .cards article a{margin-left:25px;margin-right:25px}@media(max-width:900px){#sanpham .cards{grid-template-columns:1fr 1fr}}@media(max-width:600px){#sanpham .cards{grid-template-columns:1fr}}`;
document.head.appendChild(productStyle);
const productCards=[...document.querySelectorAll('#sanpham .cards article')];
const productImages=['assets/products/img-0403.webp','assets/products/img-0406.webp','assets/products/img-0408.webp'];
